...
func unhandled_input(event:InputEvent)->void:
	if event.is_action_pressed("fire"):
		_state_machine.transition_to('Shoot', {"speed": "sneak"})
	elif event.is_action_pressed("melee"):
		_state_machine.transition_to('Melee', {"speed": "sneak"})
	elif event.is_action_pressed("reload"):
		_state_machine.transition_to('Reload', {"speed": "sneak"})
	elif event.is_action_pressed("primary_weapon"):
		_state_machine.transition_to('SwapWeapon', {"speed": "sneak", "event": "primary"})
	elif event.is_action_pressed("secondary_weapon"):
		_state_machine.transition_to('SwapWeapon', {"speed": "sneak", "event": "secondary"})
	else:
